...
class Category(object):
	...
	def assign_handover_setting(self, handover_setting, radius):
		self.handover_setting = handover_setting
		self.modify_pe_handover(handover_setting, radius)

	def modify_pe_handover(self, handover_setting, radius):
		for pe in self.pe_list:
			pe.assign_handover_params(handover_setting, radius)